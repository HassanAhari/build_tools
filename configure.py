...
parser.add_option("--qt-dir", action="store", type="string", dest="qt-dir", default="/usr/local/Qt-5.15.12/bin", help="defines qmake directory path. qmake can be found in qt-dir/compiler/bin directory")
...
parser.add_option("--compiler", action="store", type="string", dest="compiler", default="gcc_64", help="defines compiler name. It is not recommended to use it as it's defined automatically (msvc2015, msvc2015_64, gcc, gcc_64, clang, clang_64, etc)")
